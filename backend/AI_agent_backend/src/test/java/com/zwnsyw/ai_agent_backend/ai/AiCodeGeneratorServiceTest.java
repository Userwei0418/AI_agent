package com.zwnsyw.ai_agent_backend.ai;
...
class AiCodeGeneratorServiceTest {
    ...
    void generateHtmlCode() {
        HtmlCodeResult result = aiCodeGeneratorService.generateHtmlCode("做个程序员Zwww的工作记录小工具");
        Assertions.assertNotNull(result);
    }

    @Test
    void generateMultiFileCode() {
        MultiFileCodeResult multiFileCode = aiCodeGeneratorService.generateMultiFileCode("做个程序员Zwww的留言板");
...
//    @Test
//    void generateHtmlCode() {
//        HtmlCodeResult result = aiCodeGeneratorService.generateHtmlCode(1,"做个程序员Zwww的工作记录小工具");
//        Assertions.assertNotNull(result);
//    }
